...
sed -i -e "s/VERSION/6.19.0/" %ROOT_DIR%\cli-ci\installers\windows\windows-installer-x64.iss
...
zip %ROOT_DIR%\cf-cli-installer-win64\cf-cli-installer_winx64.zip %ROOT_DIR%\cli-ci\cf_installer.exe
